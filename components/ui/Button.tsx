...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-ink-900 text-paper-50 hover:bg-accent-700 active:bg-accent-900 disabled:bg-ink-300",
  secondary:
    "bg-transparent text-ink-900 border border-ink-900/25 hover:border-ink-900/60 hover:bg-ink-900/5 active:bg-ink-900/10",
  ghost: "bg-transparent text-ink-700 hover:bg-ink-900/5 active:bg-ink-900/10",
  danger: "bg-error-600 text-paper-50 hover:bg-error-700 active:bg-error-700 disabled:bg-ink-300",
};
