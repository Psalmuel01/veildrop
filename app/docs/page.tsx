        ...
        <div className="min-w-0 flex-1">
          ...
          <Section id="overview" title="Overview">
            ...
            <p>
              ...
              tracked token unlock events, prices dropped 7–15% within days of an unlock exceeding 1%
              of circulating supply, as traders position against the visible allocation before it
              settles. Encrypting the amount removes that signal entirely while keeping the transfer
              itself fully verifiable on-chain.
            </p>
            ...
            <div className="mt-2 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-ink-900/10 p-5">
                ...
                <ul className="mt-3 flex flex-col gap-1.5 text-sm text-ink-500">
                  ...
                  <li>+ Good for public/opt-in campaigns</li>
          ...
          <Section id="creating" title="Creating a distribution">
            <ol className="flex flex-col gap-4">
              {[
                ...
                ["Review & execute", "A checklist confirms registration, approvals, and balance before the button enables — nothing executes until every check is green."],
          ...
          <Section id="faq" title="FAQ">
            <div className="flex flex-col gap-5">
              {[
                ...
                ["Why did I get asked to sign/approve something before I could send?", "Registration and operator approval are one-time, per-wallet prerequisites the underlying contracts require before they can move your confidential balance — after the first time, later distributions skip straight to execution."],
              ].map(([q, a]) => (
                <div key={q}>
            ...
            <p className="mt-4 flex items-center gap-2 text-sm text-ink-500">
              ...
              Ready to try it? <Link href="/distribute" className="text-accent-600 hover:underline">Create a distribution</Link> or <Link href="/faucet" className="text-accent-600 hover:underline">get test tokens</Link>.
            </p>
          </Section>
        </div>
      </main>
